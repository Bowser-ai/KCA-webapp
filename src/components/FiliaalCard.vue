<template>
  <div class="result-card">
    ...
    <a class="address-link" :href="addressMapUrl"
      ><p>{{ filiaal.address }}</p></a
    >
    <p v-if="filiaal.postcode" class="header">Postcode</p>
    <p v-if="filiaal.postcode">{{ filiaal.postcode }}</p>
    <p v-if="filiaal.telnum" class="header">Telefoon</p>
    <p v-if="filiaal.telnum">{{ filiaal.telnum }}</p>
